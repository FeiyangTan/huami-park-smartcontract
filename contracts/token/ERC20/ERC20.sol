 ...
 */
contract ERC20 is Context, IERC20, IERC20Metadata,hb {
    ...
    //发送红包
    function sentHB(address recipient, uint amount) public{
        ...
        _balances[sender] = senderBalance - amount;
        //添加红包
        addHB(recipient,amount);
    }
    
    function getHB(address sender, uint hbID) public{
        //删除红包
        uint amount = deleteHB(sender,hbID);
        //增加余额
